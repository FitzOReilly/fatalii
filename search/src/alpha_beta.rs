...
pub const LATE_MOVE_PRUNING_MIN_DEPTH: usize = 5;
...
struct SearchParams {
    ...
    late_move_pruning_min_depth: usize,
...
impl AlphaBeta {
    pub fn new(evaluator: Box<dyn Eval + Send>, table_size: usize) -> Self {
        Self {
            ...
            search_params: SearchParams {
                ...
                late_move_pruning_min_depth: LATE_MOVE_PRUNING_MIN_DEPTH,
    ...
    fn prune_late_move(&self, search_data: &mut SearchData<'_>, move_count: usize) -> bool {
        ...
        depth <= self.search_params.late_move_pruning_min_depth
