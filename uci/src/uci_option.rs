...
use search::{
    alpha_beta::{
        ...
        LATE_MOVE_PRUNING_BASE, LATE_MOVE_PRUNING_FACTOR, LATE_MOVE_PRUNING_MAX_DEPTH,
        REVERSE_FUTILITY_MARGIN_BASE, REVERSE_FUTILITY_MARGIN_PER_DEPTH,
        REVERSE_FUTILITY_PRUNING_MAX_DEPTH, SEE_PRUNING_MARGIN_QUIET, SEE_PRUNING_MARGIN_TACTICAL,
...
pub const OPTIONS: [UciOption; 17] = [
    UciOption {
        name: "Hash",
    ...
    UciOption {
        ...
        r#type: OptionType::Spin(SpinProps {
            default: LATE_MOVE_PRUNING_MAX_DEPTH as i64,
            min: 1,
            max: 8,
    ...
    UciOption {
        ...
        r#type: OptionType::Spin(SpinProps {
            default: SEE_PRUNING_MARGIN_QUIET as i64,
            min: -300,
            max: 0,
    ...
    UciOption {
        ...
        r#type: OptionType::Spin(SpinProps {
            default: SEE_PRUNING_MARGIN_TACTICAL as i64,
            min: -300,
            max: 0,
    ...
    UciOption {
        ...
        r#type: OptionType::Spin(SpinProps {
            default: SEE_PRUNING_MAX_DEPTH as i64,
            min: 0,
            max: 8,
